...
/**
 * The Protein Data Bank file format is a textual file
 * describing the three-dimensional structures of molecules.
 */
...
/**
 * CSS2DRenderer is a simplified version of CSS3DRenderer.
...
function createMenu() {
  for (const m in MOLECULES) {
    ...
    button.addEventListener("click", () => loadMolecule(url));
  }
}
