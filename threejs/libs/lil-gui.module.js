...
const s = { isPrimitive: !0, match: (t) => "string" == typeof t, fromHexString: e, toHexString: e },
  n = {
    isPrimitive: !0,
  ...
  l = {
    ...
    toHexString: ({ r: t, g: i, b: e }, s = 1) =>
      n.toHexString(((t * (s = 255 / s)) << 16) ^ ((i * s) << 8) ^ ((e * s) << 0)),
  },
  o = [s, n, r, l];
class a extends t {
  constructor(t, i, s, n) {
...
class d extends t {
    ...
    const o = (t) => {
        if (l) {
          const s = t.clientX - i,
            n = t.clientY - e;
          Math.abs(n) > 5
            ? (t.preventDefault(), this.$input.blur(), (l = !1), this._setDraggingStyle(!0, "vertical"))
            : Math.abs(s) > 5 && a();
        }
        if (!l) {
          const i = t.clientY - s;
          (r -= i * this._step * this._arrowKeyMultiplier(t)),
            n + r > this._max ? (r = this._max - n) : n + r < this._min && (r = this._min - n),
  ...
  _initSlider() {
    ...
    const t = (t) => {
        ...
        let e =
          ((s = t), (n = i.left), (r = i.right), (l = this._min), (o = this._max), ((s - n) / (r - n)) * (o - l) + l);
        var s, n, r, l, o;
    ...
    this.$slider.addEventListener("mousedown", (s) => {
      ...
      this.$slider.addEventListener("touchstart", (t) => {
        t.touches.length > 1 ||
          (this._hasScrollBar ? ((s = t.touches[0].clientX), (n = t.touches[0].clientY), (r = !0)) : l(t),
